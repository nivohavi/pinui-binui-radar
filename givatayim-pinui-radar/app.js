...
const glossaryTerms = [
  { id: 'pinui', term: 'פינוי-בינוי', tr: 'Pinui-Binui · Evacuation and Reconstruction',
    desc: 'מסלול להתחדשות עירונית שבו נהרסים בניינים ישנים ובמקומם נבנים מבנים חדשים — בדרך כלל גבוהים ובעלי מספר דירות רב יותר. בעלי הדירות המקוריים מקבלים דירה חדשה, ואת יתרת הדירות היזם מוכר בשוק החופשי.',
    example: 'AIR — שני בניינים בני 3 קומות פונו, ובמקומם נבנה מגדל מגורים עם 333 דירות.' },
  { id: 'tama', term: 'תמ"א 38', tr: 'Tama 38 · National Master Plan 38',
    desc: 'תוכנית ארצית שאפשרה חיזוק מבנים ישנים נגד רעידות אדמה תמורת תוספת דירות. קיימים שני מסלולים עיקריים: 38/1 (חיזוק ותוספת קומות) ו-38/2 (הריסה ובנייה מחדש). התוכנית הוחלפה ברוב הרשויות בחלופת שקד או בתוכניות התחדשות מתחמיות.',
    example: 'אם מודעה מבטיחה "תמ"א 38" — מומלץ לבדוק מתי הוגשה הבקשה. כיום רוב הפרויקטים מקודמים במסלול פינוי-בינוי.' },
  { id: 'tochnit', term: 'תב"ע — תוכנית בניין עיר', tr: 'Tochnit Binyan Ir · Local Building Plan',
    desc: 'המסמך התכנוני המרכזי המגדיר את זכויות הבנייה בקרקע — מספר קומות, שימושים מותרים, תשתיות ודרכים. כדי שפרויקט פינוי-בינוי ייצא לפועל, נדרשת תב"ע מאושרת בתוקף.',
    example: 'שלבי אישור תב"ע: הכנה ← הגשה ← הפקדה ← שמיעת התנגדויות ← אישור ← מתן תוקף.' },
  { id: 'hefkada', term: 'תוכנית מופקדת / מאושרת', tr: '',
    desc: 'תוכנית מופקדת היא תוכנית שהוגשה רשמית ופתוחה לציבור למשך 60 יום להגשת התנגדויות. תוכנית מאושרת היא תוכנית שעברה את שלב ההתנגדויות וקיבלה תוקף חוקי.',
    example: 'הפער בין שלב ה"הכנה" לשלב ה"מתן תוקף" יכול להימשך מספר שנים.' },
  { id: 'mavat', term: 'מבא"ת', tr: 'MAVAT · Government Planning Database',
    desc: 'המערכת הממשלתית המרכזית לניהול תוכניות בנייה בישראל. ניתן לחפש בה תוכניות לפי גוש וחלקה, כתובת או מספר תוכנית, ולצפות במסמכים המלאים.',
    example: 'טרם רכישת דירה, מומלץ לאתר את התוכנית הרלוונטית באתר mavat.iplan.gov.il ולבדוק את הסטטוס העדכני.' },
  { id: 'vaada', term: 'ועדה מקומית / מחוזית', tr: '',
    desc: 'ועדה מקומית (ברמת העירייה) מאשרת היתרי בנייה ותוכניות בסמכות מקומית. ועדה מחוזית מאשרת תוכניות רחבות היקף, כגון מתחמי פינוי-בינוי גדולים.',
    example: 'היזם מגיש תב"ע לוועדה המחוזית ← לאחר האישור, מוגשת בקשה להיתר בנייה לוועדה המקומית.' },
  { id: 'heter', term: 'היתר בנייה', tr: '',
    desc: 'האישור הסופי המונפק על ידי הוועדה המקומית המאפשר את תחילת העבודות בשטח. ללא היתר בנייה, לא ניתן להתחיל בהריסה או בבנייה.',
    example: 'יזם המבטיח ש"ההיתר בדרך" ללא מסמך רשמי — דורש בדיקה מעמיקה של סטטוס הרישוי.' },
  { id: 'sarvan', term: 'דייר סרבן', tr: '',
    desc: 'בעל דירה המסרב לחתום על הסכם הפינוי-בינוי. לביצוע פרויקט נדרשת הסכמה של 80% מבעלי הדירות. החוק מאפשר הגשת תביעה נגד סרבנים שסירובם אינו סביר.',
    example: 'אם אחוז החתימות נמוך מ-67%, מדובר בשלב ראשוני מאוד של הפרויקט.' },
  { id: '66', term: 'רוב של 67% / 80%', tr: '',
    desc: '67% הוא הרוב הדרוש לקידום תוכנית במוסדות התכנון. 80% הוא הרוב הנדרש להגשת תביעה נגד דייר סרבן וליציאה לביצוע.',
    example: '"מתחם" יכול לכלול מספר בניינים שמתחדשים כיחידה אחת על פי התוכנית.' },
  { id: 'saif23', term: 'תביעת דייר סרבן', tr: '',
    desc: 'הליך משפטי המאפשר לרוב הנדרש של בעלי הדירות לתבוע דייר המסרב לחתום מסיבות שאינן מוצדקות. בית המשפט רשאי להורות על חתימה על ההסכם או על תשלום פיצויים.',
    example: 'הליך משפטי מול סרבנים עלול לעכב את הפרויקט ב-12 עד 36 חודשים.' },
  { id: 'hitnagdut', term: 'התנגדויות', tr: '',
    desc: 'זכות חוקית הניתנת לציבור להגיש הסתייגויות לתוכנית שהופקדה. ההתנגדויות נשמעות בפני חוקר או ועדת המשנה להתנגדויות, ועשויות להוביל לשינוי התוכנית או לביטולה.',
    example: 'תוכנית ארלוזורוב עוררה התנגדויות רבות מצד התושבים, דבר שעיכב את אישורה משמעותית.' },
  { id: 'arvut', term: 'ערבות חוק המכר', tr: '',
    desc: 'ערבות בנקאית או פוליסת ביטוח המבטיחה את כספי הרוכש במקרה שהיזם לא יוכל לעמוד בהתחייבויותיו. זוהי הגנה חובה על פי חוק המכר.',
    example: 'אין להעביר תשלומים מעל 7% ממחיר הדירה ללא קבלת ערבות חוק מכר מתאימה.' },
  { id: 'hashvaha', term: 'היטל השבחה', tr: '',
    desc: 'תשלום חובה לרשות המקומית בעקבות עליית ערך המקרקעין עקב אישור תוכנית. בפרויקטי פינוי-בינוי, מקובל שהיזם הוא זה שנושא בעלות ההיטל עבור בעלי הדירות.',
    example: 'גובה ההיטל הוא מחצית מעליית הערך (50%) שנוצרה בזכות התוכנית החדשה.' },
  { id: 'shevach', term: 'מס שבח', tr: '',
    desc: 'מס על הרווח הנוצר ממכירת זכות במקרקעין. בפינוי-בינוי קיימים פטורים ספציפיים לבעלי דירות כדי לאפשר את היתכנות הפרויקט.',
    example: 'מומלץ לוודא קבלת פטור ממס שבח במסגרת ההסכם מול היזם.' },
  { id: 'rechisha', term: 'מס רכישה', tr: '',
    desc: 'מס המוטל על רוכש זכות במקרקעין. גובה המס תלוי בשווי הנכס ובעובדה האם זוהי דירתו היחידה של הרוכש או דירה נוספת.',
    example: 'ברכישת דירה להשקעה (דירה שנייה ומעלה), מס הרכישה מתחיל מ-8%.' },
  { id: 'nesach', term: 'נסח טאבו', tr: '',
    desc: 'תעודה רשמית המונפקת על ידי לשכת רישום המקרקעין המפרטת את מצב הזכויות בנכס: בעלות, הצמדות, משכנתאות ועיקולים.',
    example: 'ניתן להנפיק נסח טאבו דיגיטלי באתר הממשלתי בעלות של כ-16 ש"ח.' },
  { id: 'gush', term: 'גוש וחלקה', tr: '',
    desc: 'שיטת זיהוי המקרקעין בישראל. הגוש מייצג אזור גאוגרפי והחלקה מייצגת את תא השטח הספציפי. לעיתים קיימת גם חלוקה לתתי-חלקות (בבתים משותפים).',
    example: 'זיהוי נכס לפי גוש וחלקה הוא הדרך המדויקת ביותר לבדיקת סטטוס תכנוני.' },
  { id: 'rashut', term: 'הרשות הממשלתית להתחדשות עירונית', tr: '',
    desc: 'הגוף הממשלתי האמון על קידום והסדרת תחום ההתחדשות העירונית בישראל. הרשות מכריזה על מתחמים, מפרסמת מדריכים ומסייעת בקידום תהליכים מול הרשויות.',
    example: 'באתר הרשות ניתן למצוא מידע על מתחמים מוכרזים ומדריכים לבעלי דירות.' }
];
...
const App = {
  ...
  renderSidebar() {
    ...
    if (v === 'dashboard' || v === 'deals') {
      ...
      const statusList = [['yes','לקנייה'],['maybe','למעקב'],['no','להמתנה']];
  ...
  renderDashboard() {
    ...
    html += this._kpi('מתחמים רלוונטיים', inBudget, `מתוך ${getAllZonesFlat().length} מתחמים`, 'kpi-cyan', '🏢', `App.scrollToSection('zone-table')`);
    html += this._kpi('פוטנציאל מוביל', topScore ? topScore.valueScore.toFixed(1) : '-', topScore ? topScore.zone : '', 'kpi-gold', '⭐', topScore ? `App.navigate('zone','${topScore.zoneId}')` : '');
    html += this._kpi('ממוצע ₪/מ"ר', avgPpsqm ? '₪' + Math.round(avgPpsqm / 1000) + 'K' : '-', 'ממוצע המתחמים המוצגים', 'kpi-amber', '📊', `App.scrollToSection('zone-table')`);
    ...
    const cols = [
      ...
      { key: 'premium', label: 'פרמיית רווח' },
      { key: 'timeline', label: 'אופק מימוש' },
      { key: 'status', label: 'סטטוס' },
      { key: 'score', label: 'ציון', tooltip: 'פוטנציאל רווח שנתי מתואם סיכון: (פרמיה / שנים) × מקדם סיכון' }
    ];
    for (const c of cols) {
    ...
    sorted.forEach((z, i) => {
      ...
      const statusLabel = { yes: 'לקנייה', maybe: 'למעקב', no: 'להמתנה' }[z.status] || z.status;
